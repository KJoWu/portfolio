      ...
      <div className="grid grid-cols-5 gap-20 text-md h-full py-12 ">
        <section
          ...
          <div className="text-gray-800 w-full">
            ...
            <div className="mb-8">
              <h1 className="font-bold text-4xl text-gray-800 leading-[1.3em]"> Setting the Scene: The Challenges of Flair Airlines</h1>
            ...
            <blockquote className="text-xl italic font-base text-gray-900 dark:text-white my-10">
              ...
              <p> Imagine you're at the airport, rushing through security, checking screens for gate changes, and feeling the pressure of time ticking down. In this high-stress environment, every piece of information is crucial. Suddenly, the app you rely on for your boarding pass and flight details stops working. Desperation sets in as you frantically search your phone for a screenshot of your QR code. Panic ensues. </p>
                <br />  
