    ...
    <>
      <section className="mb-12 mt-[3em] ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8">
          <div>
            <Image src={issueScreen1} alt="Image 1" quality={95} className="w-full h-48 object-cover mb-4 rounded-lg shadow-lg" />
          ...
          <div>
            <Image src={issueScreen1} alt="Image 2" quality={95} className="w-full h-48 object-cover mb-4 rounded-lg shadow-lg" />
            <div className="bg-white p-4 rounded-lg shadow-lg">
          ...
          <div>
            <Image src={issueScreen1} alt="Image 3" quality={95} className="w-full h-48 object-cover mb-4 rounded-lg shadow-lg" />
            <div className="bg-white p-4 rounded-lg shadow-lg">
