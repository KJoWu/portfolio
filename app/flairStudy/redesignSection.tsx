    ...
    <>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="mb-6 text-gray-700leading-7mt-6">
        ...
        <div>
            ...
            <section className="col-span-2 flex items-center rounded-xl">
              <div className="text-gray-800 w-full">
                <div className="font-light leading-relaxed text-base text-gray-700 col-span-3">
                  ...
                  <ul className="list-disc list-inside ml-4 text-gray-700 space-y-2 mb-6 text-gray-700leading-7mt-6">
          ...
          <div className="grid grid-cols-5 gap-10 text-md h-full pt-36 pb-20">
            ...
            <section className="col-span-2 flex items-center rounded-xl">
              <div className="text-gray-800 w-full">
                ...
                <div className="font-light leading-relaxed text-base text-gray-700 col-span-3">
                  <ul className="list-disc list-inside ml-4 text-gray-700 space-y-2leading-7">
          ...
          <div className="grid grid-cols-5 gap-10 text-md h-full pb-36">
            <section className="col-span-2 flex items-center rounded-xl">
              <div className="text-gray-800 w-full">
                <h1 className="text-2xl font-semibold text-gray-900 mb-8">Maximize Value with Flair's Budget-Friendly Deals</h1>
                <div className="font-light leading-relaxed text-base text-gray-700  ">
                  <p className="leading-8 ">
                    Flair's top ranking in Canada is due to its cheap deals. The website provides these travel deals, but the app does not.
                  </p>
                  <ul className="list-disc list-inside ml-4 text-gray-700 space-y-2leading-7">
                    <li><span className="font-semibold">Include Travel Deals:</span> Add a section for travel deals in the app to attract users.</li>
                    <li><span className="font-semibold">Track User Interaction:</span> Monitor clicks to assess interest.</li>
                    <li><span className="font-semibold">Consider Menu Update:</span> Create a dedicated tab for travel deals if engagement is high.</li>
                  </ul>
          ...
          <div className="grid grid-cols-11 gap-10 text-md h-full py-30">
            <Image src={designLoggedIn} alt="issue 1" quality={95} className="rounded-xl w-full h-full object-contain bg-white col-span-7" />

            <section className="col-span-4 flex items-center rounded-xl">
              <div className="text-gray-800 w-full">
                <div className="relative flex items-center mb-8">
                  <h1 className="text-2xl font-semibold text-gray-900">Optimizing Access to Bookings</h1>
                </div>
                <div className="font-light leading-relaxed text-base text-gray-700 col-span-3">
                  <ul className="list-disc list-inside ml-4 text-gray-700 space-y-2 leading-7">
