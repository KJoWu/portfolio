...
export const RedesignSection = () => {
  return (
    <>
      <div className="mb-8">
        <h1 className="font-medium text-3xl text-gray-800 leading-[1.4em]">Redesigning the App</h1>
      ...
      <div className="space-y-4">
        ...
        <ContentWithImage
          ...
          text={`<span class="font-semibold mt-4 block">Simplify Navigation:</span>Move the hamburger menu to the bottom in a column called 'More' to streamline access and consolidate all actions in one place.
          <br/><span class="font-semibold mt-4 block">Relocate In-Flight Page:</span> The In-Flight page, which informs users how to access Flair online, is not directly related to booking flights. Consider moving it to the 'more' tab. Before doing so, use a heat map to analyze user interaction and determine the page's usability and frequency of use.`}
          image={designMenu}
          alt="menu"
        />
        ...
        <ContentWithImage
          ...
          text={`<span class="font-semibold mt-4 block">Airplane Icon:</span> Icon now transformed to a toggle button to improve usability.
          <br/><span class="font-semibold mt-4 block">Traveler Info Display:</span> Field now shows detailed traveler info for quick comprehension.
          <br/><span class="font-semibold mt-4 block">Personalized Greeting (Optional):</span> A greeting has been added making the app more welcoming.
          <br/><span class="font-semibold mt-4 block">Modernized Styling:</span> Form style has been updated for a more modern look.`}
          image={designHome}
          alt="issue 1"
          reverse
        />
        ...
        <ContentWithImage
          ...
          <br/><span class="font-semibold mt-4 block">Include Travel Deals:</span> Add a section for travel deals in the app to attract users. This ensures users <span class="bg-[#b2ff94]">get access to the same deals as the website</span>, potentially increasing app usage and satisfaction.
          <br/><span class="font-semibold mt-4 block">Track User Interaction:</span> Monitor clicks to assess interest and consider creating a dedicated tab for travel deals if engagement is high.`}
          image={designSales}
          alt="issue 2"
        />
        ...
        <ContentWithImage
          ...
          text={`<span class="font-semibold mt-4 block">Guests:</span> Flair lacks incentives for users to create an account. <span class="bg-[#b2ff94]">A compelling CTA button emphasizing a 'fast' experience can address this</span> by showing how logging in streamlines their experience with automatic booking information display.
  <br/><span class="font-semibold mt-4 block">Signed-in Users:</span> If a user is already signed in, <span class="font-medium">we should display their upcoming reservations without requiring them to input information.</span> This addresses one of the common pain points users mentioned earlier about the product.`}
